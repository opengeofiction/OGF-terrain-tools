...
# perl C:\usr\OGF-terrain-tools\bin\terrainTransform.pl size=1024 bbox=39.30947,45.55100,44.93461,48.09214 src=elev:SathriaLCC:5:all tgt=elev:SathriaLCC:6:all -noExist
